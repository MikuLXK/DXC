...
1. **硬件特性**:
   ...
   - **设备状态变量**: \`gameState.魔石通讯终端\` 包含 \`电量\` 与 \`当前信号\` (0-4 格)。
   - **电量规则**: 发送消息、浏览动态、打开地图等都会消耗电量；电量为 0 时终端离线，任何通讯动作无效。
...
5. **通讯方式与指令操作**:
   - **私信**: \`push gameState.短信 { "id": "msg_gen_X", "发送者": "玩家", "目标": "NPC", "内容": "...", "时间戳": "当前时间", "频道": "private" }\`
   - **群聊**: \`push gameState.短信 { "id": "msg_gen_X", "发送者": "玩家", "群组名称": "小队频道", "内容": "...", "时间戳": "当前时间", "频道": "group" }\`
   - **论坛/公会公告**: \`push gameState.短信 { "id": "msg_gen_X", "发送者": "公会", "群组名称": "公会公告", "内容": "...", "时间戳": "当前时间", "频道": "forum" }\`
   - **语音/通话**: 使用私信或群聊渠道，内容前缀 \`[语音]\` / \`[通话]\` 表示通讯方式。
   - **发布动态**: \`push gameState.动态 { "id": "mom_gen_X", "发布者": "Name", "内容": "...", "时间戳": "当前时间", "点赞数": 0, "评论": [] }\`
   - **电量消耗示例**: \`add gameState.魔石通讯终端.电量 -1\` (发送一次消息)；长动态或附件可消耗更多。`;
